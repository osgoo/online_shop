<header class="bg-white">
  <div class="container mx-auto px-4 py-8 flex items-center">
    ...
    <div class="w-full max-w-xs xl:max-w-lg 2xl:max-w-2xl bg-gray-100 rounded-md hidden xl:flex items-center">
      <select class="bg-transparent uppercase font-bold text-sm p-4 mr-4 w-[200px]" name="" id="">
      ...
      <form action="#" method="GET">
        @csrf
        <input name="search" class="border-l border-gray-300 bg-transparent font-semibold text-sm pl-4" type="text" placeholder="Хайх утга ...">
        <button type="submit">
    ...
    <div class="ml-auto md:w-48 hidden sm:flex flex-col place-items-end">
      <span class="font-bold md:text-xl">+976 91191111</span>
